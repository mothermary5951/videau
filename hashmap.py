...
def dump(aMap, key, value):                 # print out the keys and values for each bucket in the aMap list                                   
    """Prints out what's in the Map."""
    bucket = get_bucket(aMap, key)   # names get_bucket return 'bucket'   START HERE ....                                                           i, k, v = get_slot(aMap, key)    # names get_slot return 'i, k, v'              
